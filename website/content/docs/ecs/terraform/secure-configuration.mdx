...
for an overview of task startup, task shutdown, ACL tokens, and the AWS IAM auth method for Consul on ECS.
...
<EnterpriseAlert>
If you are using Consul Enterprise, see <a href="/docs/ecs/enterprise#admin-partitions-and-namespace">Admin Partitions and Namespaces</a> for
